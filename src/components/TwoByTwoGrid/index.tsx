                    ...
                    <Box maxW={{ lg: 'lg' }}>
                        <Box mb={{ lg: '8rem' }}>
                            ...
                            <Text
                                ...
                                maxW={{ lg: 'md' }}
                            >
                                One mission control for your business, wherever
                                you go.
                            </Text>
                        </Box>
                        <FeatureImage
                        ...
                        >
                            <Feature
                                ...
                                icon={<HiBadgeCheck />}
                            >
                                Improve customer experience with efficient order
                            ...
                            >
                                Make payments easy with a variety of payment
                                methods and user-friendly checkout.
                            </Feature>
                            <Feature
                                title="Consumer Insight"
                                icon={<HiChartSquareBar />}
                            >
                                Understand customer behavior and preferences to
                            ...
                            <Feature
                                ...
                                icon={<HiTemplate />}
                            >
                                Stay on top of your business with quick access
                                to important data and metrics.
                            </Feature>
                        </SimpleGrid>
                    </Box>
                    <FeatureImage
